...
We first add categorical variables one by one to observe the impact of each categorical variable on the model. The variable f.tenure is excluded from consideration, as its inclusion does not result in a significantly improved fit. However, the remaining categorical variables examined in the Profiling segment substantially enhance the model, evidenced by a notable difference in deviance equal to 143.49.
