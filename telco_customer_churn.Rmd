...
```{r}
residualPlots(model_numeric_basic)

marginalModelPlots(model_numeric_basic)

library(effects)
plot(allEffects(model_numeric_basic))

influencePlot(model_numeric_basic)
```
...
Final residuals, falta analysis
